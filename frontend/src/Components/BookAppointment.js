...
import Doctor from "../Assets/whyChoose.png";
    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        ...
        <p className="ba-description">
          Discover the reasons to choose AyurVision for your healthcare needs.
        ...
        <p className="ba-checks ba-check-last">
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> AI-Powered Symptom Prediction
        </p>
